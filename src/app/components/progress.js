...
//         this.rate = container.getElementById('rateIndex');
//         this.arrow = container.getElementById('rateArrow');
//         this.bg = container.getElementById('rateBg');
//         this.rateChange = `rotate(${rate.dataset.index * 1.8}deg)`;
//         if (rate.dataset.index < 0 || rate.dataset.index > 100) {
//             alert('bad range');
//         } else {
//             rate.innerHTML = (rate.dataset.index);
